            ...
            <div className={styles.chatRoot}>
                <div className={styles.chatContainer}>
                            ...
                            {activeChatMode == ChatMode.WorkOnly ? (
                                <div>
                                    <div className={styles.chatEmptyStateHeader}>
                                        <img src={BlueLogo} alt="hvac bot" style={{ width: "80px", height: "80px" }} />
                                    </div>
                                    <h1 className={styles.chatEmptyStateTitle}>Get answers fast and easy</h1>
                                </div>
                    ...
                    <div className={styles.chatInput}>
                        ...
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. How can we properly handle refrigerants?)"
                            disabled={isLoading}
